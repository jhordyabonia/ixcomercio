...
define([
    ...
    return Component.extend({
        defaults: {
            ...
            template: 'Magento_PagaloVisa/payment/cc-form'
        },
            ...
            storage.get(serviceUrl).done(
                function (response) {
                    if (response.success) {
                        ...
                        var $pg_visacuotas_html = $(".field.installments_pagalovisa select");
	    ...
	    var parent = this._super();
            ...
            var additionalData = {
                ...
                'cc_fingerprint': cybs_dfprofiler("visanetgt_ixcomercioepson","live")
            };
