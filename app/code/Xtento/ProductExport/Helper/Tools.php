                    ...
                    foreach ($fieldsToCheck as $fieldToCheck) {
                        if (isset($profileData[$fieldToCheck])) {
                            ...
                            if (json_last_error() == JSON_ERROR_NONE) {
                                ...
                                $profileData[$fieldToCheck] = /*Marketplace serialize/unserialize M2.2+ workaround*/\Magento\Framework\App\ObjectManager::getInstance()->create(\Magento\Framework\Serialize\SerializerInterface::class)->serialize($jsonData);
                            }
                        }
                    }
                }
