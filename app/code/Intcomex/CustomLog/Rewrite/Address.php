...
$class = 'Magento\Quote\Model\Quote\Address';
...
$this->_logger = $logger;
        ...
        if (!$found) {
$this->_logger->debug("QuoteId:: $quoteId Class:: $class Method:: " . 'collectShippingRates():: $this->setShippingAmount(0)->setBaseShippingAmount(0)->setShippingMethod("")->setShippingDescription("")' );
...
$this->_logger->debug("QuoteId:: $quoteId Class:: $class Method:: " . 'requestShippingRates() $this->getFreeShipping():: ' . $this->getFreeShipping());
        ...
        if ($result) {
            ...
            foreach ($shippingRates as $shippingRate) {
                ...
                if ($this->getShippingMethod() == $rate->getCode()) {
                    if ($item) {
$this->_logger->debug("QuoteId:: $quoteId Class:: $class Method:: " . 'requestShippingRates() $item->setBaseShippingAmount($rate->getPrice()):: ' . $item->setBaseShippingAmount($rate->getPrice()));
...
$this->_logger->debug("QuoteId:: $quoteId Class:: $class Method:: " . 'requestShippingRates() $this->setBaseShippingAmount($rate->getPrice()):: ' . $rate->getPrice());
$this->_logger->debug("QuoteId:: $quoteId Class:: $class Method:: " . 'requestShippingRates() $this->setShippingAmount($amountPrice):: ' . $amountPrice);
                    }
