...
$class = 'Magento\SalesRule\Model\Validator';
$writer = new \Zend\Log\Writer\Stream(BP . '/var/log/FreeShipping.log');
$logger = new \Zend\Log\Logger();
$logger->addWriter($writer);
$this->_logger = $logger;
$this->_logger->debug("QuoteId:: $quoteId Class:: $class Method:: " . 'processShippingAmount() Init!');
...
$this->_logger->debug("QuoteId:: $quoteId Class:: $class Method:: " . 'processShippingAmount $appliedRuleIds:: ');
        $this->_logger->debug($appliedRuleIds);
$this->_logger->debug("QuoteId:: $quoteId Class:: $class Method:: " . 'processShippingAmount Finish!');
        return $this;
    }
