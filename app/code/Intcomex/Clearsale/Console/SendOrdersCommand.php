...
{
    const COMMAND_NAME = 'clearsale:orders:send';
    const COMMAND_DESCRIPTION = 'Send orders to Clearsale';
    ...
    protected  function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $output->writeln('Starting send orders Clearsale ' . date('Y-m-d H:i:s'));
        $this->_clearsaleObserver->sendPendingOrders();
        $output->writeln('Ending send orders Clearsale ' . date('Y-m-d H:i:s'));
