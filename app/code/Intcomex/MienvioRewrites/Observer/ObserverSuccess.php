...
class ObserverSuccess implements ObserverInterface
{
    ...
    {
        $writer = new \Zend\Log\Writer\Stream(BP . '/var/log/observerSuccess.log');
        ...
        try {
            ...
            $this->_logger->info("Productos B");
            $this->_logger->info($itemsMeasures['items']);
            ...
            if (self::IS_QUOTE_ENDPOINT_ACTIVE) {
                ...
                $this->_logger->info("Quote B");
                $this->_logger->info($mienvioResponse['quote_id']);
