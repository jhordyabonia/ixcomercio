...
namespace Intcomex\Adyen\Model;
...
class Cron extends \Adyen\Payment\Model\Cron
{
    ...
    public function __construct(
        ...
        \Adyen\Payment\Model\ResourceModel\Order\Payment $orderPaymentResourceModel,
    ...
    {
        try {
            if ($this->_order->getPayment()->getMethod() !== AdyenCcConfigProvider::CODE) {
                $this->_orderSender->send($this->_order);
                $this->_adyenLogger->addAdyenNotificationCronjob('Send order confirmation email to shopper');
            } else {
                $this->_adyenLogger->addAdyenNotificationCronjob('Skip send order confirmation');
            }
        } catch (\Exception $exception) {
            $this->_adyenLogger->addAdyenNotificationCronjob(
