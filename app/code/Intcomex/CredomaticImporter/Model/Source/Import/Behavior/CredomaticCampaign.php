...
namespace Intcomex\CredomaticImporter\Model\Source\Import\Behavior;

use Magento\ImportExport\Model\Import;

class CredomaticCampaign extends \Magento\ImportExport\Model\Source\Import\AbstractBehavior
{
    /**
     * @const Behavior code.
     */
    const BEHAVIOR_CODE = 'intcomex_credomatic_campaign';
