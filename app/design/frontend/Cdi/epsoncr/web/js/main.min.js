	    	...
	    	$.ajax({
			    ...
			    success: function(res) {
						...
						$.ajax({
							...
							success: function(resCity) {
								...
								$.each(response.localitaties, function(iResCity, valResCity){
							    	$(fieldZoneCheckout).find('select').append("<option value='"+valResCity.name+"' parentId='"+valResCity.parentId+"' postalCode='"+valResCity.postalCode+"'>"+valResCity.name+"</option>");
							  	});

								setValueWsElement('#zone_id', '#fieldZoneCheckout', 'val');
								localStorage.setItem('fieldCityCheckout', jQuery("#fieldCityCheckout option:selected").val());
							  	$('body').trigger('processStop');
							}
						});
				    });
				    ...
				    $(fieldZoneCheckout).find('select').on('change', function (e) {
						...
						localStorage.setItem('fieldZoneCheckout', jQuery("#fieldZoneCheckout option:selected").val());
