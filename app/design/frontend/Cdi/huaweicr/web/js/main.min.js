	    	...
	    	$.ajax({
			    ...
			    success: function(res) {
	    			...
	    			var htmlZones = '<select id="fieldZoneCheckout" class="select" name="zone_id" aria-required="true" aria-invalid="false" disabled>'+
	    							'<option data-title="" value="">'+$.mage.__("Por favor selecciona una zona.")+'</option>'+
	    							'</select>';
						...
						$.ajax({
							...
							success: function(resCity) {
								...
								$(fieldZoneCheckout).find('select option').remove();
                  				$(fieldZoneCheckout).find('select').append('<option data-title="" value="" selected>Por favor selecciona una zona.</option>');
