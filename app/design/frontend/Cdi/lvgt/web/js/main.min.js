require(['jquery', 'owlCarouselJs', 'jquery/ui', 'mage/translate', 'mainJs', 'domReady!'], function($) {
    ...
    jQuery(document).ready(function() {
	    ...
	    $(document).on('change',"[name='billing-address-same-as-shipping']",function(){
			identification = jQuery('.payment-method-billing-address input[name="custom_attributes[identification]"]').closest('div.field').find('span');
			if(identification.length && window.identificationLabel != ''){
                identification.text(window.identificationLabel);
            }
