...
define(
    ...
    function(
        ...
        return Component.extend({
            ...
            // Intcomex Custom Menu
            updateMenu: function () {
                let menu = $("#payment_methods_menu").find('ul');

                if (menu.length) {
                    let title_cont = $(".payment-method-title.adyen-cc-form");
                    ...
                    $(menu).prepend(
                        '<li role="presentation" class="payment-group-item debitcard active">' +
                            ...
                            '<img style="padding-left: 1rem; padding-right: 2.5rem; padding-bottom: 1rem;" src="'+window.imgFranquiciasAdyen+'" >' +
                        '</li>'
                    );
